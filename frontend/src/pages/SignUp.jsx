    ...
    >
      ...
      >
        ...
        <div className="mb-4">
          ...
          <input
            type="text"
            className=" w-full border rounded-b-lg px-3 py-2 focus:outline-none
          "
       ...
       {err&& <p className=' text-red-500 text-center my-[10px] '>*{err}</p>}
        <button className=" w-full mt-4 flex items-center justify-center  gap-2  border rounded-lg px-4 py-2 transition duration-200 border-gray-200 hover:bg-gray-200" onClick={handleGoogleAuth}>
          <FcGoogle size={20} />
