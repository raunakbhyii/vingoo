    ...
    <div className="flex items-center justify-center min-h-screen p-4 bg-[#fff9f6]">
      <div className="bg-white rounded-xl shadow-lg w-full max-w-md p-8">
        <div className=" flex items-center gap-4  mb-4">
          ...
          />
          <h1 className="text-2xl font-bold cursor-pointer text-center text-[#ff4d2d]">
            {" "}
            Forgot Password
          </h1>
        </div>
        {step == 1 && (
          <div>
            <div className="mb-6">
              ...
              <input
                type="email"
                className=" w-full border-[1px] border-gray-200 rounded-b-lg px-3 py-2 focus:outline-none 
          "
